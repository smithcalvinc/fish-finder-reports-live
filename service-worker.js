const CACHE_VERSION="ffo-reports-pwa-v53";
...
const APP_SHELL=[
  ...
  "./brand-shell.css","./brand-shell.js?v=53","./pwa.js?v=53",
  ...
  "./official_state_sources.js","./official_water_overrides.js?v=53",
  "./regional_water_search.js?v=53","./official_species_data.js",
